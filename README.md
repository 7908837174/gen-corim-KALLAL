...
> Note: the below assumes that specific versions of the [evcli](https://github.com/veraison/evcli) and the [cocli](https://github.com/veraison/corim/tree/main/cocli) tools are installed on the system.

To install `evcli` and `cocli`:

```sh
go install github.com/veraison/cocli@2fdfbe3
